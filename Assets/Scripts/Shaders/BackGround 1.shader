Shader "Tutorial/047_InvLerp_Remap/Remap"{
	...
	Properties{
		...
		_SrcOneValue ("Src One Color", Color) = (0,0,0,1)
		_SrcTwoValue ("Src Two Color", Color) = (1,1,1,1)
	...
	SubShader{
		...
		Pass{
			...
			fixed4 frag(v2f i) : SV_TARGET{
				...
				//fixed4 col = invLerp(_SrcOneValue, _SrcTwoValue, blend);
				fixed4 col = lerp(_SrcOneValue, _SrcTwoValue, blend);
				return col;
			}
